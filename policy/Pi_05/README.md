...
| `PI05_EXECUTION_HORIZON` | Actions before synchronous replanning: `16` for G2 primary, legacy `20`, or `50` (default). Prediction remains exactly H50. G2 must explicitly set `16`; this does not change historical G6 contracts. |
